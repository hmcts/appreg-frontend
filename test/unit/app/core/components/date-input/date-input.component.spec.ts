...
describe('DateInputComponent', () => {
  ...
  it('does not mark an empty search date invalid after a search is submitted', () => {
    fixture.componentRef.setInput('isSearch', true);
    fixture.componentRef.setInput('submitted', true);
    fixture.detectChanges();
  ...
  it('marks all date parts invalid when a partial search date is submitted', () => {
    fixture.componentRef.setInput('isSearch', true);
    fixture.componentRef.setInput('submitted', true);
    component.dateForm.setValue({ day: '1', month: '', year: '' });
    fixture.detectChanges();

    expect(
      fixture.nativeElement
        .querySelector('#date-day')
  ...
  it('marks the date control as touched when a date part loses focus', () => {
    const onTouched = jest.fn<void, []>();
    component.registerOnTouched(onTouched);
