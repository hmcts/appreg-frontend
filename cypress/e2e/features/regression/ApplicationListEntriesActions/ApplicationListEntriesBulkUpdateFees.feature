Feature: Application List Entries Bulk Update Fees
    ...
    Scenario Outline: Application List Entries - Bulk Update Fees - 3 ALEs with Fee Required = Y and Respondent Required = Y
        ...
        When User Checks The Checkbox In Row Of Table "Entries" With:
            ...
            | 1               | ACC-E1-{RANDOM} | Henry Taylor {SCENARIO_ID}  | Emily Clark {SCENARIO_ID}           | BS15 5AA | Condemnation of Unfit Food                                         | Yes |          |
            | 2               | ACC-E2-{RANDOM} | Sarah Johnson {SCENARIO_ID} | Greenfield Consulting {SCENARIO_ID} | B1 1AA   | Application for order re public health measures (person)           | Yes |          |
            | 3               | ACC-E3-{RANDOM} | Michael Brown {SCENARIO_ID} | Emily Clark {SCENARIO_ID}           | BS15 5AA | Application to remove an educational institution from the register | Yes |          |
        ...
        And User Should See Row In Table "Updating fees for the following application(s)" With Values:
            ...
            | Henry Taylor {SCENARIO_ID}  | Emily Clark {SCENARIO_ID}           | Condemnation of Unfit Food                                         | Yes          |          |
            | Sarah Johnson {SCENARIO_ID} | Greenfield Consulting {SCENARIO_ID} | Application for order re public health measures (person)           | Yes          |          |
            | Michael Brown {SCENARIO_ID} | Emily Clark {SCENARIO_ID}           | Application to remove an educational institution from the register | Yes          |          |
    ...
    Scenario Outline: Application List Entries - Bulk Update Fees - 2 ALEs with Fee Required = N and Respondent Required = Y
        ...
        When User Makes POST API Request To "/application-lists/:listId/entries" With Object Builder:
            ...
            | applicant.person.contactDetails.mobile              | 07900{RANDOM}                     |
            | applicant.person.contactDetails.email               | applicant.buf1.{SCENARIO_ID}@test.com  |
            ...
            | respondent.organisation.contactDetails.email        | respondent.buf1.{SCENARIO_ID}@test.com |
        ...
        When User Makes POST API Request To "/application-lists/:listId/entries" With Object Builder:
            ...
            | applicant.person.contactDetails.phone               | 01314{RANDOM}                     |
            | applicant.person.contactDetails.mobile              | 07900{RANDOM}                     |
            | applicant.person.contactDetails.email               | applicant.buf2.{SCENARIO_ID}@test.com  |
            | respondent.organisation.name                        | Smith Holdings {SCENARIO_ID}           |
            | respondent.organisation.contactDetails.addressLine1 | {SCENARIO_ID} Victoria Road            |
            | respondent.organisation.contactDetails.addressLine2 | Cardiff                           |
            | respondent.organisation.contactDetails.postcode     | CF1 1AA                           |
            | respondent.organisation.contactDetails.phone        | 02924{RANDOM}                     |
            | respondent.organisation.contactDetails.mobile       | 07910{RANDOM}                     |
            | respondent.organisation.contactDetails.email        | respondent.buf2.{SCENARIO_ID}@test.com |
            | wordingFields.0.key                                 | Date of Hearing                   |
            | wordingFields.0.value                               | today                             |
            | hasOffsiteFee                                       | false                             |
        ...
        When User Checks The Checkbox In Row Of Table "Entries" With:
            | Sequence number | Account number  | Applicant              | Respondent               | Postcode | Title                         | Fee | Resulted |
            | 1               | ACC-E5-{RANDOM} | Oliver Harris {SCENARIO_ID} | Harris Holdings {SCENARIO_ID} | CF1 1AA  | Appeal to Crown Court         | No  |          |
            | 2               | ACC-E6-{RANDOM} | John Smith {SCENARIO_ID}    | Smith Holdings {SCENARIO_ID}  | CF1 1AA  | Appeal by Case Stated (Crime) | No  |          |
        Then User Should See The Button "Actions" Is Enabled
