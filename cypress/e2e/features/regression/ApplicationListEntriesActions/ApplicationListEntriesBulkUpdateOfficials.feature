Feature: Application List Entries Bulk Update Officials
    ...
    Scenario Outline: Application List Entries - Update Officials
        ...
        When User Checks The Checkbox In Row Of Table "Entries" With:
            ...
            | 2               | ACC-E2-{RANDOM} | Sarah Johnson {SCENARIO_ID} | Greenfield Consulting {SCENARIO_ID} | B1 1AA   | Collection Order - Financial Penalty Account | No  |          |
        ...
        And User Should See Row In Table "Application(s) to update" With Values:
            ...
            | 1               | Henry Taylor {SCENARIO_ID}  | Emily Clark {SCENARIO_ID}  | Appeal to Crown Court                        |
            | 2               | Sarah Johnson {SCENARIO_ID} | Greenfield Consulting | Collection Order - Financial Penalty Account |
        ...
        Then User Fills In The "Magistrate's surname" Textbox With "Smith_{SCENARIO_ID}" Within The "Magistrate 1" FieldSet
        # Magistrate 2
        Then User Fills In The "Magistrate's first name" Textbox With "Emily" Within The "Magistrate 2" FieldSet
        Then User Fills In The "Magistrate's surname" Textbox With "Davis_{SCENARIO_ID}" Within The "Magistrate 2" FieldSet
        # Magistrate 3
        ...
        Then User Fills In The "Magistrate's surname" Textbox With "Hardy_{SCENARIO_ID}" Within The "Magistrate 3" FieldSet
        # Court Official
        ...
        Then User Fills In The "Official's surname" Textbox With "Zanetti_{SCENARIO_ID}" Within The "Court official" FieldSet
        # Save Officials
        When User Clicks On The "Save recording officials" Button
        ...
        Then User Verifies The Textbox "Magistrate's surname" Contains "Smith_{SCENARIO_ID}" Under "Magistrate 1" FieldSet In The Accordion "Officials"
        # Magistrate 2
        ...
        Then User Verifies The Textbox "Magistrate's surname" Contains "Davis_{SCENARIO_ID}" Under "Magistrate 2" FieldSet In The Accordion "Officials"
        # Magistrate 3
        ...
        Then User Verifies The Textbox "Magistrate's surname" Contains "Hardy_{SCENARIO_ID}" Under "Magistrate 3" FieldSet In The Accordion "Officials"
        # Court Official
        ...
        Then User Verifies The Textbox "Official's surname" Contains "Zanetti_{SCENARIO_ID}" Under "Court official" FieldSet In The Accordion "Officials"
        ...
        Examples:
            ...
            | user1 | todayiso | 10:20 | OPEN   | Applications to review at Test_{SCENARIO_ID} | BCC026            | today      | todaydisplay | Bristol Crown Court Set 3 | 2       | HHJ John Smith_{SCENARIO_ID} | Emily Davis_{SCENARIO_ID} | Miss Jane Hardy_{SCENARIO_ID} | Mrs Violette Zanetti_{SCENARIO_ID} |
