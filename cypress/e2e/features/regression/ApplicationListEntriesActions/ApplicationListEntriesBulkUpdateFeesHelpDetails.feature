Feature: Application list entries bulk update fees help details
  ...
  Background: Create fee-required application list entry
    ...
    When User Makes POST API Request To "/application-lists" With Body:
      ...
      | todayiso | 10:20 | OPEN   | Bulk fee help details list {SCENARIO_ID} | LCCC065           |
  ...
  Scenario: Expand and collapse bulk update fees help details
    ...
    When User Searches Application List With:
      ...
      | today |      | Bulk fee help details list {SCENARIO_ID} | LCCC065     |       |        |                |     |           |
    When User Clicks "Select" Then "Open" From Menu In Row Of Table "Lists" With:
      | Date         | Time  | Location                          | Description                         | Entries | Status |
      | todaydisplay | 10:20 | Leeds Combined Court Centre Set 7 | Bulk fee help details list {SCENARIO_ID} | 1       | OPEN   |
    When User Checks The Checkbox In Row Of Table "Entries" With:
      | Sequence number | Account number   | Applicant             | Respondent           | Postcode | Title                      | Fee | Resulted |
      | 1               | ACC-FEE-{RANDOM} | Henry Taylor {SCENARIO_ID} | Emily Clark {SCENARIO_ID} | BS15 5AA | Condemnation of Unfit Food | Yes |          |
    ...
    Then User Should See The Text "Select Off-site fee if an additional fee applies because a magistrate attended a location away from court premises. Selecting this option will apply to all selected applications." In The Accordion "Help with civil fee details"
