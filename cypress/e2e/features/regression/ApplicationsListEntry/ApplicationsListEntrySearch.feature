Feature: Applications List Entry Search
    ...
    Scenario: Verify components on applications list entry (ALE) search page
        ...
        Then User Should See The Textbox "Respondent post code" In The Accordion "Advanced search"
        Then User Should See The Textbox "Criminal justice area" In The Accordion "Advanced search"
        Then User Should See The Textbox "Other location description" In The Accordion "Advanced search"
        Then User Should See The Textbox "Standard applicant code" In The Accordion "Advanced search"
        Then User Should See The Textbox "Account reference" In The Accordion "Advanced search"
