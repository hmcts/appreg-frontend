...
export class BannerHelper {
  static verifyBannerText(expectedText: string): void {
    TextElement
      .getTextByContent(expectedText, 'app-notification-banner [role="region"]')
      .should('be.visible');
  }

  static verifyBannerNotPresent(unexpectedText: string): void {
    TextElement
      .getTextByContent(unexpectedText, 'app-notification-banner [role="alert"]')
      .should('not.exist');
  }
  ...
  static verifyErrorBannerNotPresent(unexpectedText: string): void {
    TextElement.getTextByContent(unexpectedText, 'app-error-summary [role="alert"]')
      .should('not.exist');
  }
}
