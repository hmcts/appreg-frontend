...
export type ApplicationsListEntryCreateForm = FormGroup<{
...
export type ApplicationsListEntryCreateFormValue = ReturnType<
  ApplicationsListEntryCreateForm['getRawValue']
>;
